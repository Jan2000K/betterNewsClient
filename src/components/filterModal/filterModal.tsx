...
export default function FilterModal(props: {
    modalVis: genericStateProp<boolean>
    newsSources: genericStateProp<string[] | undefined>
    filterChange: genericStateProp<number>
}) {
    ...
    return (
        ...
        <section className="fixed z-1 left-0 top-0 w-full h-full overflow-auto bg-slate-500/80">
            ...
            <div className="relative mx-auto top-20  w-4/5 h-2/5  bg-slate-100 md:w-3/5 lg:w-2/5">
                <div className="absolute pl-1 pt-1 font-roboto w-full">
                    <div>
                        <p className="inline-block md:text-lg">
                            {blockedWordsTxt}
                        </p>
                        <div
                            className="float-right inline-block p-0 text-2xl select-none text-slate-500 hover:cursor-pointer"
                ...
                <button
                    className="absolute right-3 bottom-2 p-2 rounded hover:bg-emerald-400 md:text-lg bg-emerald-400 2xl:bg-inherit"
